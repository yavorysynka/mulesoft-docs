...
. If you are going to work with Mule applications and APIs to connect your digital assets, set up your workstation according to the link:/#dev-checklist[Getting Started Checklist for Developers].
. If you are going to manage deployments see the link:/#getting-started-deploy[Getting Started Checklist for Deployment]
. To set up platform permissions or monitor deployed assets see the link:#getting-started-manage[Getting Started Checklist for Administration].
...
=== Getting Started Checklist for Administration
...
[[app-network]]
== How to Build an Application Network
...
[[design-develop-apis]]
=== Design, Deploy and Implement APIs

Consider the action word that defines the interaction between two systems or applications. Define these different actions in APIs. Use a proxy application to control access to it.
