...
The best way to learn is to access the cloud version of Anypoint Platform and walk through the tutorials in the link:/getting-started[Getting Started] section.
