...
For *Mule deployment*, see link:/runtime-manager/deployment-strategies[deployment strategies]. That document explains the standard app-to-runtime deployment workflows.
