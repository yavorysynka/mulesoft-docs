...
project's src/main/resources folder. When you are ready for production, you can copy the updated XML file or the new 
DTD and XSD files into the PIP's JAR file.
...
----
+
Make your changes and copy the version XML file to the src/main/resources folder.
