...
On this page you learn how to perform a basic local installation of Mule runtime so you can run a Mule application locally.

You can skip to other physical deployment strategies of Mule runtime on the link:/mule-user-guide/v/3.8/deploying[Deploying] page.
