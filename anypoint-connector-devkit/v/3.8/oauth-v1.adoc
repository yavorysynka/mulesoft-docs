...
=== To Add OAuth Maven Project Dependencies
...
=== To Add @OAuth Annotation on the @Connector Class 
...
=== To Configure @Connector Class Properties
...
=== To Protect @Processor Methods with OAuth
...
== To Include OAuth Headers in a Client Class
...
=== To Configure the OAuth Supported Connector in a Flow
...
NOTE:
For more information on configuring an *HTTPS connector*, see the link:/mule-user-guide/v/3.7/https-transport-reference[HTTPS Transport Reference] and link:/anypoint-connector-devkit/v/3.8/http-basic-authentication[Examples for HTTPS].
