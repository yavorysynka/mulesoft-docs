= To Set Up API Access for Connector
...
== To Set Up Access to SOAP-Based APIs
...
== To Use Java Libraries for Access to Service
...
== To Set Up Access to a Cloud API
...
=== Example: Setting up Salesforce API Access
...
=== Example: Setting Up Twitter API Access
...
*NEXT:* Continue to link:/anypoint-connector-devkit/v/3.8/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project] to begin developing your connector.
