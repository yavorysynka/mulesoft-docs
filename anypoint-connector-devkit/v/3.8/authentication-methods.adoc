= Background on Authentication Methods
...
In DevKit, basic authentication is enabled using the link:/anypoint-connector-devkit/v/3.8/connection-management[Connection Management] framework.
...
For more information, see link:/anypoint-connector-devkit/v/3.8/oauth-v1[OAuth V1] or link:/anypoint-connector-devkit/v/3.8/oauth-v2[OAuth V2].
...
For more information, see link:/anypoint-connector-devkit/v/3.8/http-basic-authentication[HTTP Basic Authentication].
...
include::devkit-authentication-reference.adoc[]
