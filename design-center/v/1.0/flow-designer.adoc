...
When writing into the expression editor, if you enclose your expression in `{}` curly brackets, this automatically opens up the dictionary editor. This editor lets you set up the keys and values of an object as a simple table, which makes it more easily readable and less error-prone.
