...
|===
|Command |Description
|<<runtime-mgr standalone-applications artifact>> | Downloads application artifact binary
|<<runtime-mgr standalone-applications deploy>> | Deploys a new application to an on-premises server, server group or cluster
|<<runtime-mgr standalone-applications describe-json>> | Shows a raw on-premises application JSON response
|<<runtime-mgr standalone-applications modify>> | Changes an on-premises application artifact
|<<runtime-mgr standalone-applications start>> | Starts an on-premises application
|<<runtime-mgr standalone-applications delete>> | Deletes an on-premises application
|<<runtime-mgr standalone-applications describe>> | Shows detailed info of an on-premises application
|<<runtime-mgr standalone-applications list>> | Lists all applications in the environment
|<<runtime-mgr standalone-applications restart>> | Restarts an on-premises application
|<<runtime-mgr standalone-applications stop>> | Stops an on-premises application
|===
...
=== runtime-mgr standalone-applications artifact

[source,Example]
----
> runtime-mgr standalone-applications artifact [options] <appId> <directory>
----

This command downloads the application artifact of the `appId` application, to the directory passed in `directory`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications deploy

[source,Example]
----
> runtime-mgr standalone-applications deploy [options] <targetId> <name> <zipfile>
----

This command deploys the application passed as a zip file in the path `zipfile` to the environment passed in `targetId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications describe-json

[source,Example]
----
> runtime-mgr standalone-applications describe-json [options] <appId>
----

This command describes the application passed in `appId` as a raw JSON response. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications modify

[source,Example]
----
> runtime-mgr standalone-applications modify [options] <appId> <zipfile>
----
...
=== runtime-mgr standalone-applications start

[source,Example]
----
> runtime-mgr standalone-applications start [options] <appId>
----

This command starts the application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications delete

[source,Example]
----
> runtime-mgr standalone-applications delete [options] <appId>
----
...
=== runtime-mgr standalone-applications describe

[source,Example]
----
> runtime-mgr standalone-applications describe [options] <appId>
----

This command describes the on-premises application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications list

[source,Example]
----
> runtime-mgr standalone-applications list [options]
----

This command lists all on-premises applications. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications restart

[source,Example]
----
> runtime-mgr standalone-applications restart [options] <appId>
----

This command restarts the application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr standalone-applications stop

[source,Example]
----
> runtime-mgr standalone-applications stop [options] <appId>
----
