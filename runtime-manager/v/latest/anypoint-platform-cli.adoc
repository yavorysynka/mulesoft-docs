...
|===
|Command |Description
|<<runtime-mgr hybrid-applications artifact>> | Downloads application artifact binary
|<<runtime-mgr hybrid-applications deploy>> | Deploys a new application to an on-premises server, server group or cluster
|<<runtime-mgr hybrid-applications describe-json>> | Shows a raw on-premises application JSON response
|<<runtime-mgr hybrid-applications modify>> | Changes an on-premises application artifact
|<<runtime-mgr hybrid-applications start>> | Starts an on-premises application
|<<runtime-mgr hybrid-applications delete>> | Deletes an on-premises application
|<<runtime-mgr hybrid-applications describe>> | Shows detailed info of an on-premises application
|<<runtime-mgr hybrid-applications list>> | Lists all applications in the environment
|<<runtime-mgr hybrid-applications restart>> | Restarts an on-premises application
|<<runtime-mgr hybrid-applications stop>> | Stops an on-premises application
|===
...
|===
|Command |Description
|<<runtime-mgr pcf-applications delete>> | Deletes PCF application
|<<runtime-mgr pcf-applications describe>> | Shows detailed info of PCF application
|<<runtime-mgr pcf-applications list>> | Lists all PCF applications in the environment
|<<runtime-mgr pcf-applications restart>> | Restarts PCF application
|<<runtime-mgr pcf-applications stop>> | Stops PCF application
|<<runtime-mgr pcf-applications deploy>> | Deploys a new application to PCF space
|<<runtime-mgr pcf-applications describe-json>> | Shows raw PCF application JSON response
|<<runtime-mgr pcf-applications modify>> | Edits an application deployed to PCF space
|<<runtime-mgr pcf-applications start>> | Starts PCF application
|===
...
|<<runtime-mgr server list>> | Changes an on-premises application artifact
...
|===
|Command |Description
|<<runtime-mgr hybrid-alert describe>> | Describes an alert
|<<runtime-mgr hybrid-alert create>> | Creates new hybrid alert
|<<runtime-mgr hybrid-alert modify>> | Modifies hybrid alert
|<<runtime-mgr hybrid-alert list>> | Lists all hybrid alerts in the environment
|===
...
=== runtime-mgr hybrid-applications artifact

[source,Example]
----
> runtime-mgr hybrid-applications artifact [options] <appId> <directory>
----

This command downloads the application artifact of the `appId` application, to the directory passed in `directory`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications deploy

[source,Example]
----
> runtime-mgr hybrid-applications deploy [options] <targetId> <name> <zipfile>
----

This command deploys the application passed as a zip file in the path `zipfile` to the environment passed in `targetId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications describe-json

[source,Example]
----
> runtime-mgr hybrid-applications describe-json [options] <appId>
----

This command describes the application passed in `appId` as a raw JSON response. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications modify

[source,Example]
----
> runtime-mgr hybrid-applications modify [options] <appId> <zipfile>
----

This command modifies the on-premises application passed in `appId` with the zip file application passed in `zipfile` as a path. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications start

[source,Example]
----
> runtime-mgr hybrid-applications start [options] <appId>
----

This command starts the application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications delete

[source,Example]
----
> runtime-mgr hybrid-applications delete [options] <appId>
----
...
=== runtime-mgr hybrid-applications describe

[source,Example]
----
> runtime-mgr hybrid-applications describe [options] <appId>
----

This command describes the on-premises application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications list

[source,Example]
----
> runtime-mgr hybrid-applications list [options]
----

This command lists all on-premises applications. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications restart

[source,Example]
----
> runtime-mgr hybrid-applications restart [options] <appId>
----

This command restarts the application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-applications stop

[source,Example]
----
> runtime-mgr hybrid-applications stop [options] <appId>
----

This command stops the on-premises application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr pcf-applications delete

[source,Example]
----
> runtime-mgr pcf-applications delete [options] <appId>
----
...
=== runtime-mgr pcf-applications describe

[source,Example]
----
> runtime-mgr pcf-applications describe [options] <appId>
----

This command describes the PCF deployed application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr pcf-applications list

[source,Example]
----
> runtime-mgr pcf-applications list [options]
----

This command lists all your PCF deployed applications. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr pcf-applications restart

[source,Example]
----
> runtime-mgr pcf-applications restart [options] <appId>
----

This command restarts your PCF deployed application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr pcf-applications stop

[source,Example]
----
> runtime-mgr pcf-applications stop [options] <appId>
----

This command stops the PCF deployed appplication passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr pcf-applications deploy

[source,Example]
----
> runtime-mgr pcf-applications deploy [options] <name> <zipfile>
----
...
=== runtime-mgr pcf-applications describe-json

[source,Example]
----
> runtime-mgr pcf-applications describe-json [options] <appId>
----

This command shows a raw JSON description of the PCF deployed application passed in `appId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr pcf-applications modify

[source,Example]
----
> runtime-mgr pcf-applications modify [options] <appId> [zipfile]
----
...
=== runtime-mgr pcf-applications start

[source,Example]
----
> runtime-mgr pcf-applications start [options] <appId>
----
...
=== runtime-mgr hybrid-alert describe

[source,Example]
----
> runtime-mgr hybrid-alert describe [options] <alertId>
----

This command describes the alert passed in `alertId`. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.

=== runtime-mgr hybrid-alert create

[source,Example]
----
> runtime-mgr hybrid-alert create [options] <name>
----

This command creates a new hybrid alert with the id passed in `name`.
...
=== runtime-mgr hybrid-alert modify

[source,Example]
----
> runtime-mgr hybrid-alert modify [options] <alertId>
----

This command modifies the hybrid alert passed in `alertId`.
...
=== runtime-mgr hybrid-alert list

[source,Example]
----
> runtime-mgr hybrid-alert list [options]
----

This command lists all hybrid alerts in the current environment. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.
